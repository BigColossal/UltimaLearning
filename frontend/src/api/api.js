...
// Skill API
export const getSkills = (userId) => api.get(`/skills?userId=${userId || 'default'}`);
...
export const createDomain = (skillId, data) => api.post(`/domains/skill/${skillId}`, data);
export const updateDomain = (id, data) => api.put(`/domains/${id}`, data);
export const deleteDomain = (id) => api.delete(`/domains/${id}`);

// Subskill API
export const getSubskills = (domainId) => api.get(`/subskills/domain/${domainId}`);
export const getSubskillById = (id) => api.get(`/subskills/${id}`);
export const createSubskill = (domainId, data) => api.post(`/subskills/domain/${domainId}`, data);
export const updateSubskill = (id, data) => api.put(`/subskills/${id}`, data);
export const addXP = (id, amount) => api.patch(`/subskills/${id}/xp`, { amount });
